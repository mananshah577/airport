              ...
              return GestureDetector(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.r), color: controller.isInternet.isFalse ? AppColors.to.primaryColor : AppColors.to.textColor),
                    child: Padding(
                ...
                onTap: () {
                  ...
                  params.addAll({
                    "latitude": controller.isInternet.isFalse
                        ? controller.airportDataFromLocal[index]["lat"]
                        : controller.airportData[keys[index]]["lat"]
                  });
                  params.addAll({
                    "longitude": controller.isInternet.isFalse
                        ? controller.airportDataFromLocal[index]["lon"]
                        : controller.airportData[keys[index]]["lon"]
                  });
                  params.addAll({
                    "airportName": controller.isInternet.isFalse
                        ? controller.airportDataFromLocal[index]["name"]
                        : controller.airportData[keys[index]]["name"]
                  });
                  params.addAll({
                    "airportCity": controller.isInternet.isFalse
                        ? controller.airportDataFromLocal[index]["city"]
                        : controller.airportData[keys[index]]["city"]
                  });
                  params.addAll({
                    "airportState": controller.isInternet.isFalse
                        ? controller.airportDataFromLocal[index]["state"]
                        : controller.airportData[keys[index]]["state"]
                  });
                  params.addAll({
                    "airportCountry": controller.isInternet.isFalse
                        ? controller.airportDataFromLocal[index]["country"]
                        : controller.airportData[keys[index]]["country"]
                  });
